...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-cronos/1.png)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-cronos/2.png)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-cronos/3.png)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-cronos/4.1.png)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-cronos/4.png)
Its an Login page!!
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-cronos/5.png)[br/](br/)
All we need to do is change ``302 Found`` to ``200 Ok``.

For that open ``Proxy -> Options -> Match and Replace``[br/](br/)
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-cronos/6.png)

``/welcome.php`` it leads to a page where it has a tool to ping.[br/](br/)
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-cronos/7.png)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-cronos/8.png)[br/](br/)
We got the shell

While checking for any useful files in ``/var/www`` found ``/admin.php/config.php``  and its give me ``mysql`` credentials
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-cronos/9.png)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-cronos/10.png)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-cronos/11.png)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-cronos/12.png)

Started my Listener and waited for the cronjob to execute my reverse shell
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-cronos/13.png)
