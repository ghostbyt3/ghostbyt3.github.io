...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-registry/1.1.png)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-registry/1.png)

## HTTPS:

Nmap Reveals the commonName for the ``HTTPS`` is ``docker.registry.htb``, So I added them in ``/etc/hosts``[br/](br/)
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-registry/2.png)
...
```
``/v2``[br/](br/)
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-registry/3.png)[br/](br/)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-registry/5.png)
...
>[https://blog.dixitaditya.com/exploiting-docker-registry/](https://blog.dixitaditya.com/exploiting-docker-registry/)

We already know the version of API ``/v2``, we can find list of repos in the registry using ``/_catalog``[br/](br/)
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-registry/4.png)[br/](br/)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-registry/6.png)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-registry/7.png)

``latest``[br/](br/)
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-registry/8.png)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-registry/9.png)[br/](br/)
Like this I downloaded all.

The file is an ``gzip compressed data`` so I rename to ``.gz`` and I decompress it with ``gzip -d ``[br/](br/)
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-registry/10.png)[br/](br/)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-registry/11.png)

Its an ``.gz`` file renamed and extracted now it is an ``tar`` file ``tar -xf`` to decompress the file.[br/](br/)
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-registry/12.png)[br/](br/)
We got bunch of directories, we already got ssh passphrase so I started looking for ssh private keys.[br/](br/)

![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-registry/13.png)[br/](br/)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-registry/14.png)

## SSH Login:

Using ``GkOcz221Ftb3ugog`` I logged in ``ssh -i id_rsa bolt@registry.htb``[br/](br/)
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-registry/15.png)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-registry/16.png)

Found a login page in ``http://backup.registry.htb/bolt/bolt``, Cant login with default credentials.
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-registry/17.png)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-registry/18.png)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-registry/19.png)[br/](br/)
So the password is ``strawberry``.

Logged in with ``admin : stawberry``
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-registry/20.png)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-registry/21.png)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-registry/22.png)

![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-registry/23.png)

## Privilege Escalation:

We already know, we can run ``restic`` as root in ``www-data`` without password.
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-registry/24.png)
