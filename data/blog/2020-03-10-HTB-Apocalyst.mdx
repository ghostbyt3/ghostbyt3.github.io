...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-apocalyst/1.png)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-apocalyst/2.png)

So I Started ``Wpscan`` and found and an user.<br/>
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-apocalyst/3.png)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-apocalyst/4.png)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-apocalyst/5.png)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-apocalyst/6.png)

``wpscan -U falaraki -P ~/CTF/HTB/Boxes/Apocalyst/list.txt --url http://apocalyst.htb/``

![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-apocalyst/7.png)
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-apocalyst/8.png)

We got the password for the user.
``Username: falaraki, Password: Transclisiation``

![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-apocalyst/9.png)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-apocalyst/10.png)

After Uploaded the file, Open the page in new tab and Started my Listener.
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-apocalyst/11.png)

I look at the home directory and found ``.secret`` which looks like base64 encoded.
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-apocalyst/12.png)

There is an online tool called [Base64Decode](https://www.base64decode.org/) to decode and it gives us me a password.
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-apocalyst/13.png)

Logged in with ``SSH`` with `` falaraki : Y0uAINtG37TiNgTH!sUzersP4ss ``<br/>
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-apocalyst/14.png)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-apocalyst/15.png)

Added ``wolf:46Xd.1NlqFBp.:0:0:root:/root:/bin/bash`` at the bottom.<br/>
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-apocalyst/16.png)

I'm Root now <br/>
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-apocalyst/17.png)
