...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/symfonos4/1.png)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/symfonos4/2.png)

Downloaded all log files to my machine.<br/>
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/symfonos4/3.png)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/symfonos4/4.png)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/symfonos4/5.png)

All we need to do is change ``302 Found`` to ``200 Ok`` For that open ``Proxy -> Options -> Match and Replace``.

![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/symfonos4/6.png)

Now If I visit ``/sea.php`` it displays a new page.
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/symfonos4/7.png)

So If I select a GOD the url changes to ``/sea.php?file=hades`` maybe Local File Inclusion.
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/symfonos4/8.png)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/symfonos4/9.png)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/symfonos4/10.png)

Now its injected, Time to get reverse shell.

![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/symfonos4/11.png)

When checking ``/var/www/html/atlantis.php`` found ``mysql`` credentials.

![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/symfonos4/12.png)

``root : yVzyRGw3cG2Uyt2r``

I logged with those and got admin hash.<br/>
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/symfonos4/13.png)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/symfonos4/55.png)

Uploaded My Enumeration Script and Found this 

![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/symfonos4/14.png)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/symfonos4/15.png)

Now I can visit ``http://192.168.1.136:8081``, It displays this page 

![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/symfonos4/16.png)

When I click the Main page it directs to 

![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/symfonos4/17.png)

But ``192.168.1.136:8081/whoami`` is suspecious, So I intercept the request in Burp 

![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/symfonos4/18.png)

``username`` looks like base64encoded so I decoded that 

![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/symfonos4/19.png)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/symfonos4/20.png)

I'm Root!!

!![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/symfonos4/21.png)