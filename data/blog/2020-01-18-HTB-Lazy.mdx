...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-lazy/1.png)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-lazy/2.png)
There is a ``Login and Register`` tab. I created a new account.
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-lazy/3.png)[br/](br/)
Once Account Created, I logged in with the credentials.
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-lazy/4.png)

I intercept the webpage using ``burp`` to check if there is anything suspecious.
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-lazy/5.png)
And I found there is an ``auth`` in Cookie.

So I changed the ``auth`` and ``send`` that request and is shows ``Invalid Padding``
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-lazy/6.png)
...
```
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-lazy/7.png)[br/](br/)
I used my auth from the cookie.[br/](br/)
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-lazy/8.png)

We can change the ``user=admin`` so we can get his ``auth`` and login as ``admin``.
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-lazy/9.png)[br/](br/)
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-lazy/10.png)[br/](br/)
We got ``admin`` auth.

So I replaced our ``auth`` with the admin's auth.
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-lazy/11.png)

Yeah We logged in as admin, There is ``My Key`` which gives us ssh private key.
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-lazy/12.png)

Downloaded to my machine and gave it permission and I used that key to login as ``mitsos`` because its the file name.
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-lazy/13.png)

## Privilege Escalation:

There is a binary file called ``backup`` when I execute it prints us ``/etc/shadow``[br/](br/)
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-lazy/14.png)

While checking the ``strings`` of it[br/](br/)
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-lazy/15.png)

It shows ``cat /etc/shadow`` and ``cat`` full path is not specified.

So I checked ``PATH`` and where is ``cat`` actually located.[br/](br/)
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-lazy/16.png)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-lazy/17.png)

This will give us shell if its executed.[br/](br/)
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-lazy/18.png)

We don't have permission on ``/usr/local/sbin`` so I changed the ``/tmp`` in  ``PATH``  to make it search there first.

> export PATH=/tmp:$PATH

![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-lazy/19.png)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-lazy/20.png)
