...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-friendzone/1.png)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-friendzone/2.png)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-friendzone/3.png)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-friendzone/4.png)[br/](br/)
I logged in ``without password`` and downloaded the file.

![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-friendzone/5.png)[br/](br/)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-friendzone/6.png)

> dig - DNS lookup utility

By using this we can find other domains available for the webpage.
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-friendzone/7.png)[br/](br/)
Found some new domains , I added those new entries to ``/etc/hosts``

I started with ``https://administrator1.friendzone.red``[br/](br/)
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-friendzone/8.png)[br/](br/)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-friendzone/9.png)

The dashboard seems to be deal with images with some paramaters.
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-friendzone/10.png)

So I started testing one from the displayed one.
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-friendzone/11.png)[br/](br/)
Look at the parameters, may be we can do ``LFI``.
I tested with ``php wrapper``
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-friendzone/12.png)[br/](br/)
Its working and ``Timestamp`` is the page and ``.php`` suffix is added automatically.[br/](br/)
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-friendzone/13.png)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-friendzone/14.png)

We know the location of it from ``smbmap``[br/](br/)
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-friendzone/15.png)

Listening on my machine[br/](br/)
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-friendzone/16.png)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-friendzone/18.png)

Found some writable files from my Enumeration script[br/](br/)
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-friendzone/17.png)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-friendzone/19.png)[br/](br/)
So I started checking ``reporter.py`` [br/](br/)
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-friendzone/20.png)[br/](br/)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-friendzone/21.png)

Open my terminal and started listening and we need to wait sometime since it is ``cronjob``
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-friendzone/22.png)
