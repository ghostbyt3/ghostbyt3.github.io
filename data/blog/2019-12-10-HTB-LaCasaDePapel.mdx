...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-lacasadepapel/1.png)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-lacasadepapel/2.png)

## HTTPS:

It shows some certification error[br/](br/)
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-lacasadepapel/22.png)

## FTP:

I checked the version ``vsftpd 2.3.4``, I found some exploit[br/](br/)
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-lacasadepapel/3.png)

Its not working , may be they patched it
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-lacasadepapel/4.png)[br/](br/)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-lacasadepapel/5.png)
...
I used same `` file_get_contents`` to view the file[br/](br/)
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-lacasadepapel/6.png)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-lacasadepapel/7.png)
> openssl req -new -key ca.key -out server.csr

Then Generate a Self-Signed Certificate from an Existing Private Key and CSR
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-lacasadepapel/8.png)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-lacasadepapel/9.png)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-lacasadepapel/10.png)

Once added Just refresh the webpage[br/](br/)
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-lacasadepapel/11.png)[br/](br/)
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-lacasadepapel/12.png)

On url it represents some path so I changed that [br/](br/)
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-lacasadepapel/13.png)

I opened ``.ssh`` dir but can't see get the private flags

![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-lacasadepapel/14.png)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-lacasadepapel/15.png)

Its directly downloading the file, so we encode the ``id_rsa`` and pass that to url we can download that![br/](br/)
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-lacasadepapel/16.png)[br/](br/)
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-lacasadepapel/17.png)

Got the private key lets try login in ``ssh``
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-lacasadepapel/18.png)

## Privilege Escalation:

There is a file ``memcached.ini``[br/](br/)
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-lacasadepapel/19.png)

It executes the ``memcached.js`` in the directory.
So I edited that to get shell (we have writable permission)[br/](br/)
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-lacasadepapel/20.png)

I started listening on my machine[br/](br/)
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/htb-lacasadepapel/21.png)
