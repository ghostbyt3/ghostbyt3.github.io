...
tags: [windows,easy,ldap,kerberos,secretsdump,dcsync,sharphound,AD]
---

![https://raw.githubusercontent.com/0xw0lf/0xw0lf.github.io/master/img/htb-sauna/Untitled.png](https://raw.githubusercontent.com/0xw0lf/0xw0lf.github.io/master/img/htb-sauna/Untitled.png)

We are going to pwn Sauna which is an easy windows machine from Hack The Box.                                                             
...
It's an normal webpage, Let's see what we get here.

![https://raw.githubusercontent.com/0xw0lf/0xw0lf.github.io/master/img/htb-sauna/Untitled%201.png](https://raw.githubusercontent.com/0xw0lf/0xw0lf.github.io/master/img/htb-sauna/Untitled%201.png)

At the `/about.html` page, I found some of the Team members name. Maybe we can save it for users.

![https://raw.githubusercontent.com/0xw0lf/0xw0lf.github.io/master/img/htb-sauna/Untitled%202.png](https://raw.githubusercontent.com/0xw0lf/0xw0lf.github.io/master/img/htb-sauna/Untitled%202.png)
...
The only thing I got here is new domain name `EGOTISTICAL-BANK.local/`

## AS-Rep Roasting

Since the port 88 is open, we can move on to the kerberosting technique. But to do Kerberosting technique we need credentials on the domain to authenticate. But we have a chance if 

`Do not require Kerberos preauthentication` is True. There is a tool called `GetNPUsers.py` from [Impackets](https://github.com/SecureAuthCorp/impacket).
...
We got the login credentials now `FSmith : Thestrokes23`
...
![https://raw.githubusercontent.com/0xw0lf/0xw0lf.github.io/master/img/htb-sauna/Untitled%203.png](https://raw.githubusercontent.com/0xw0lf/0xw0lf.github.io/master/img/htb-sauna/Untitled%203.png)
...
![https://raw.githubusercontent.com/0xw0lf/0xw0lf.github.io/master/img/htb-sauna/Untitled%204.png](https://raw.githubusercontent.com/0xw0lf/0xw0lf.github.io/master/img/htb-sauna/Untitled%204.png)

Now **Queries** -> **Find Principals with DCSync Rights**

![https://raw.githubusercontent.com/0xw0lf/0xw0lf.github.io/master/img/htb-sauna/gg.png](https://raw.githubusercontent.com/0xw0lf/0xw0lf.github.io/master/img/htb-sauna/gg.png)
...
![https://raw.githubusercontent.com/0xw0lf/0xw0lf.github.io/master/img/htb-sauna/Untitled%205.png](https://raw.githubusercontent.com/0xw0lf/0xw0lf.github.io/master/img/htb-sauna/Untitled%205.png)
...
![https://raw.githubusercontent.com/0xw0lf/0xw0lf.github.io/master/img/htb-sauna/Untitled%206.png](https://raw.githubusercontent.com/0xw0lf/0xw0lf.github.io/master/img/htb-sauna/Untitled%206.png)
