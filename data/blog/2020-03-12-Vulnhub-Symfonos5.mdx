...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/symfonos5/1.png)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/symfonos5/2.png)

All we need to do is change ``302 Found`` to ``200 Ok`` For that open ``Proxy -> Options -> Match and Replace``.
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/symfonos5/3.png)

Now we can visit ``/home.php``
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/symfonos5/4.png)

When checking those tabs this looks Local FIle Inclusion 
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/symfonos5/5.png)

I checked that in Burp and yeah its a LFI
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/symfonos5/6.png)

I tried to read ``admin.php`` using LFI
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/symfonos5/7.png)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/symfonos5/8.png)
...
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/symfonos5/9.png)[br/](br/)
``zeus  :  cetkKf4wCuHC9FET ``

I tried login with this in SSH[br/](br/)
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/symfonos5/10.png)

## Privilege Escalation:

Like always I started with ``sudo -l``[br/](br/)
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/symfonos5/11.png)[br/](br/)
We can run ``dpkg`` as root without password.

Searched that in [GTFOBins](https://gtfobins.github.io/gtfobins/dpkg/)[br/](br/)
![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/symfonos5/12.png)[br/](br/)
The machine doesn't have fpm so I created that payload in my machine and uploaded here.

![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/symfonos5/13.png)

Proof:

![](https://raw.githubusercontent.com/ghostbyt3/ghostbyt3.github.io/master/public/static/images/symfonos5/14.png)
